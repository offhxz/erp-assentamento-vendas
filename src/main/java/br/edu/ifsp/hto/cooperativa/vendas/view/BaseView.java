...
public abstract class BaseView extends JFrame {
    ...
    private JPanel criarMenuLateral() {
        ...
        JButton btnGerarNotaFiscal = criarBotao("Gerar Nota Fiscal"); // Nota Fiscal
        ...
        // Ação do novo botão
        btnGerarNotaFiscal.addActionListener(e -> {
            new GerarNotaFiscalView().setVisible(true); // Nota Fiscal
            dispose();
        });
        ...
        panelBotoes.add(btnGerarNotaFiscal);  // Nota fiscal
